...
from new_siren.mod_conv_fc import EqualLinear
...
class MultiHeadMappingNetwork(nn.Module):
  ...
  def __init__(self,
               z_dim=128,  # todo 原维度 128
               hidden_dim=128,  # todo 原维度 128
               base_layers=4,
               head_layers=0,
               head_dim_dict=None,
               add_norm=False,
               ...
               **kwargs):
    super().__init__()
    head_dim_dict = {'nerf_w0': hidden_dim, 'nerf_w1': hidden_dim, 'nerf_rgb': hidden_dim}  # todo 原维度 128
    # head_dim_dict = {'nerf_w0': 256, 'nerf_w1': 256, 'nerf_w2': 256, 'nerf_rgb_0': 256, 'nerf_rgb_1': 256}  # todo 增加
